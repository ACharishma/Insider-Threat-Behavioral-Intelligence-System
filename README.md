...
>
An enterprise-grade cybersecurity intelligence platform designed to proactively monitor user activities, detect behavioral anomalies, map digital assets, and evaluate insider risk profiles. This repository contains the core setup, User Authentication module, and Employee Identity & Profile Management modules built during Week 1 of the internship.
---
## 1. Project Overview
...
Week 1 has successfully established the security foundation of the **Insider Threat Behavioral Intelligence System**. By completing the authentication modules and profile management panels, the system has a secure framework ready for activity monitoring and anomaly ingestion. All endpoints are verified, and the project is properly configured for collaborative development using Git/GitHub.
